...
async def unwelcome(client):
    ...
    boot_msg = "Hi! Sorry to kick you out of the server, but you haven’t chosen a House role in the week we gave you :frowning: If you’d like to come back to the server, here’s an invite link: https://discord.gg/q3H6ETD   Please don’t forget this time, and thank you!"
