...
def group_hug(hugger, mentions, text):
    ...
    gif_to_caption = [
        ...
        ("https://cdn.discordapp.com/attachments/592480821890514944/662728572502540289/image0.gif",
            "A bunny slips out of a lemur’s hug before it and several other bunnies return for a group hug."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662728349130555402/image0.gif",
            "A tiger puts its arm around another tiger in a cuddle pile."),
...
def hug(hugger, mentions, text):
    ...
    gif_to_caption = [
        ...
        ("https://cdn.discordapp.com/attachments/592480821890514944/653748142436646912/image0.gif",
            "Ginger cat-mother draws her kitten to her and embraces it very tightly. The kitten nibs at her face."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/628792308070088742/image0.gif",
            "A little girl pulls an owl with a white face into her arms."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/628792046509096970/image0.gif",
            "An orange cat nuzzles it’s head against a black cat as it deepens its hug."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/608501943220043777/image0.gif",
            "A cartoon white bear give a comforting hug to a crying brown bear."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662727200612679726/image0.gif",
            "A small puppy tries to get a grip on a cat the same size as it for a hug. The cat puts up with it as the puppy slips."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662727396725620737/image0.gif",
            "A preschooler hugs the face of a lying down dog bigger than herself. They both smile afterwards."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662727676418719774/image0.gif",
            "An orange cat jumps up to hug the neck of a fluffy black dog."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662727869285400598/image0.gif",
            "A baby panda hugs a ball close."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662728063779471378/image0.gif",
            "A raccoon tentatively reaches to hug a resting grey cat."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662728382156636190/image0.gif",
            "A baby koala hugs a bigger koala, then attempts to climb on its back."),
        ("https://cdn.discordapp.com/attachments/592480821890514944/662728875511382016/image0.gif",
            "At the Los Angeles Zoo, a baby monkey hugs an adult holding a banana."),
